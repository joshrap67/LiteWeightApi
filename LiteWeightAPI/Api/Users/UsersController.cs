...
public class UsersController : BaseController
{
	...
	[MaxLimit, InvalidRequest, MiscError, AlreadyExists]
	[PushNotification]
	[ProducesResponseType(typeof(FriendResponse), 200)]
	[ProducesResponseType(typeof(BadRequestResponse), 400)]
	public async Task<ActionResult<FriendResponse>> SendFriendRequest(SendFriendRequestRequest request)
	{
	...
	[InvalidRequest, MaxLimit, MiscError, UserNotFound]
	[PushNotification]
	...
	/// <remarks>Accepts a friend request from the specified user. Fails if the authenticated user has reached the maximum allowed amount of friends.</remarks>
	/// <param name="userId">Id for the friend request to accept</param>
	...
	[HttpDelete("{userId}/remove-friend")]
	[PushNotification]
	[ProducesResponseType(200)]
	[ProducesResponseType(typeof(ResourceNotFoundResponse), 404)]
	...
	/// <param name="userId">User id of the friend request to cancel</param>
