...
public class LinkFirebaseMessagingTokenRequest
{
	/// <summary>
	/// Firebase token to associate with the user. Enables push notifications to be sent to the device associated with the token.
	/// </summary>
