...
public class CurrentUserService : ICurrentUserService
{
	...
	public CurrentUserService(IRepository repository, IMapper mapper, IStorageService storageService,
		IFirebaseAuthService firebaseAuthService, ICurrentUserValidator currentUserValidator, IClock clock)
	{
	...
	{
		var user = await _repository.GetUser(userId);
		_currentUserValidator.ValidSetCurrentWorkout(user, workoutId);
